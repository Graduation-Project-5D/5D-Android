...
import java.util.List;
    ...
    public class AdapterImageScoreItem extends BaseAdapter {
        ...
        public AdapterImageScoreItem(Context context, ArrayList<DataImageFile> imageFiles) {
            mContext = context;
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_image_score, null);
                viewHolder.imageView = (ImageView) convertView.findViewById(R.id.imageView);
                viewHolder.checkBox = (CheckBox) convertView.findViewById(R.id.checkbox);
                viewHolder.textView = (TextView)convertView.findViewById(R.id.score);
            ...
            viewHolder.textView.setText(df.format(d)+"");
            return convertView;
        }
